        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'index')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('dashboard/main_sidebar_trans.index') }}</span><span
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{trans('dashboard/main_sidebar_trans.sections')}}</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('section.index') }}">عرض الكل </a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('doctor.index') }}">{{trans('dashboard/doctors.view_all')}}</a></li>
